...
namespace facter { namespace util {
    ...
    string sanityze_name(string name) {
      ...
      ostringstream o_sanityzed_name;
      auto match_begin =
      ...
      auto sanityzed_name = o_sanityzed_name.str();
      sanityzed_name.erase(sanityzed_name.end() - 1);

      return sanityzed_name;
    }
